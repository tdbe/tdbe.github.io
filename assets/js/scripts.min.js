...
function handleIsMobile(){
	if(isMobile())
	{
		const elems = document.getElementsByClassName("hidableMobile");
		for (let i = 0; i < elems.length; i++) {
			elems.item(i).classList.remove("hide");
		}
		
		const elems = document.getElementsByClassName("hidableDesktop");
		for (let i = 0; i < elems.length; i++) {
			elems.item(i).classList.add("hide");
		}
	}
	else
	{

...
function handleResize(){
	...
	var smallWidth = 'width=640, initial-scale=1.8 zoom 10% target-densitydpi=high-dpi';
	var largeWidth = 'width=device-width, initial-scale=1.8 zoom 10% target-densitydpi=high-dpi';

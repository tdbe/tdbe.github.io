...
function handleResize(){
	...
	var smallWidth = 'width=device-width, initial-scale=0.2 zoom 10% target-densitydpi=high-dpi';
	var largeWidth = 'width=device-width, initial-scale=0.2 zoom 10% target-densitydpi=high-dpi';

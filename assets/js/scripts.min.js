...
function handleIsMobile(){
	if(isMobile())
	{
		const elems = document.getElementsByClassName("hideOnMobile");
		for (let i = 0; i < elems.length; i++) {
			elems.item(i).classList.remove("hideOnMobile");
		}
	}
	else
	{
		const elems = document.getElementsByClassName("hideOnDesktop");
		for (let i = 0; i < elems.length; i++) {
			elems.item(i).classList.remove("hideOnDesktop");
		}
	}
